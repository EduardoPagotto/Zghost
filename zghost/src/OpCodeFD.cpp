...
void instrFD__LD_iREGpDD_NN(Z80* z, const uint8_t& opcode) {
    ...
    z->writeMem(z->IY.get() + static_cast<uint16_t>(R16::signExtend(offset)), value);
}
...
void instrFD__LD_B_iREGpDD(Z80* z, const uint8_t& opcode) {
    ...
    uint8_t offset = z->load8();
    // z->Memory.ContendReadNoMreq_loop(z->pc, 1, 5)
    z->B = z->readMem(z->IY.get() + static_cast<uint16_t>(R16::signExtend(offset)));
}
...
void instrFD__LD_C_iREGpDD(Z80* z, const uint8_t& opcode) {
    ...
    uint8_t offset = z->load8();
    // z->Memory.ContendReadNoMreq_loop(z->pc, 1, 5)
    z->C = z->readMem(z->IY.get() + static_cast<uint16_t>(R16::signExtend(offset)));
}
...
void instrFD__LD_D_iREGpDD(Z80* z, const uint8_t& opcode) {
    ...
    uint8_t offset = z->load8();
    // z->Memory.ContendReadNoMreq_loop(z->pc, 1, 5)
    z->D = z->readMem(z->IY.get() + static_cast<uint16_t>(R16::signExtend(offset)));
}
...
void instrFD__LD_E_iREGpDD(Z80* z, const uint8_t& opcode) {
    ...
    uint8_t offset = z->load8();
    // z->Memory.ContendReadNoMreq_loop(z->pc, 1, 5)
    z->E = z->readMem(z->IY.get() + static_cast<uint16_t>(R16::signExtend(offset)));
}
...
void instrFD__LD_H_iREGpDD(Z80* z, const uint8_t& opcode) {
    ...
    uint8_t offset = z->load8();
    // z->Memory.ContendReadNoMreq_loop(z->pc, 1, 5)
    z->H = z->readMem(z->IY.get() + static_cast<uint16_t>(R16::signExtend(offset)));
}
...
void instrFD__LD_L_iREGpDD(Z80* z, const uint8_t& opcode) {
    ...
    uint8_t offset = z->load8();
    // z->Memory.ContendReadNoMreq_loop(z->pc, 1, 5)
    z->L = z->readMem(z->IY.get() + static_cast<uint16_t>(R16::signExtend(offset)));
}
...
void instrFD__LD_A_iREGpDD(Z80* z, const uint8_t& opcode) {
    ...
    uint8_t offset = z->load8();
    // z->Memory.ContendReadNoMreq_loop(z->pc, 1, 5)
    z->A = z->readMem(z->IY.get() + static_cast<uint16_t>(R16::signExtend(offset)));
}
...
void instrFD__ADD_A_iREGpDD(Z80* z, const uint8_t& opcode) {
    ...
    uint8_t offset = z->load8();
    // z->Memory.ContendReadNoMreq_loop(z->pc, 1, 5)
    uint8_t bytetemp = z->readMem(z->IY.get() + static_cast<uint16_t>(R16::signExtend(offset)));
    z->add(bytetemp);
}
...
void instrFD__EX_iSP_REG(Z80* z, const uint8_t& opcode) {
    ...
    z->writeMem(z->sp + 1, z->IYH);
    z->writeMem(z->sp, z->IYL);
